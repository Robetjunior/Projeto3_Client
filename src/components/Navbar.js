  ...
  return (
    ...
    <div className="collapse navbar-collapse " id="navbarNavDropdown">
      <ul className="navbar-nav ml-auto  justify-content-endlex-row-reverse w-50">
        ...
        <li className="nav-item ml-auto">
          <Link className="nav-link " to="/">
          <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-layout-text-window" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="nav-item ml-auto">
          <Link className="nav-link" to="/">
          <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-headset" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
