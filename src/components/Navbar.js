      ...
      <div className="collapse navbar-collapse " id="navbarNavDropdown">
          ...
          {props.loggedInUser._id ? (
            <div>
              <span className="navbar-text mr-2">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-envelope mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <React.Fragment>
              <li className="nav-item ml-auto">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-door-open mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {props.loggedInUser._id ? (
          <Link className="text-light" to="/logout">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-door-closed mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
